...
describe('user service', () => {
  ...
  it('should create a user', async () => {
    ...
    expect(user).toHaveProperty('firstName', 'Gigi')
    expect(user).toHaveProperty('username', 'gigixinhdep')
  })
  ...
  it('should sign in a user', async() => {
    ...
    const signedIn = await UserService.signIn(signIn.username, signIn.password)
    expect(signedIn).toHaveProperty('username', 'gigixinhdep')
